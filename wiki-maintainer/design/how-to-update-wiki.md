...
First, understand the goal of this project. Read `overview.md` and `design/wiki-structure.md` to orient yourself.

Then, familiarize yourself with the existing wiki contents.
...
Check whether the wiki overview needs updating.
